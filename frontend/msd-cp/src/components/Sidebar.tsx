...
import {
  ...
  Upload, Trophy, Heart, Eye, Video, Plus,
...
const Sidebar: React.FC<SidebarProps> = ({ isDarkMode }) => {
  ...
  return (
    <div className={`fixed left-4 top-1/2 transform -translate-y-1/2 z-40 flex flex-col items-center space-y-4 p-4 transition-all duration-300 ease-out ${
